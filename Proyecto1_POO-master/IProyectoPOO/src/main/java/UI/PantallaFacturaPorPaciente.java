...
public class PantallaFacturaPorPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Facturación por Paciente");
        ...
        jButton2.setText("Marcar como Pagada");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Concretas.Insumo suero = new Concretas.Insumo("Suero fisiológico 500 ml","Botella",800);
        Concretas.Item item = new Concretas.Item(suero,1);
        cita.anadirProducto(item);

        Concretas.Factura f = new Concretas.Factura(cita);

        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);
        model.setColumnIdentifiers(new String[]{"Cantidad","Prescripción","Tipo","Presentación","Precio"});

        String[][] m = f.getMatrizFactura();
        for (int col = 0; col < m[0].length; col++) {
            model.addRow(new Object[]{m[0][col], m[1][col], m[2][col], m[3][col], m[4][col]});
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new PantallaFacturaPorPaciente().setVisible(true));
    }
